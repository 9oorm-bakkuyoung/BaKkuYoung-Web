    ...
    <div className="flex min-h-screen flex-col">
      ...
      >
        ...
        <button
          ...
          className={`absolute mx-5 w-[352px] rounded-md py-4 text-white transition-all duration-300 ${isProductSelected ? "bg-teal-500 hover:bg-teal-600" : "cursor-not-allowed bg-gray-400"}`}
        >
          교환 신청하기
        </button>
      </div>
